...
INTRINS_OVR(AARCH64_TRUNC_V4F32, trunc, LLVMVectorType (LLVMFloatType (), 4))
INTRINS_OVR(AARCH64_TRUNC_V2F32, trunc, LLVMVectorType (LLVMFloatType (), 2))
INTRINS_OVR(AARCH64_TRUNC_V1F64, trunc, LLVMVectorType (LLVMDoubleType (), 1))
INTRINS_OVR(AARCH64_TRUNC_F32, trunc, LLVMFloatType ())
INTRINS_OVR(AARCH64_CEIL_V4F32, ceil, LLVMVectorType (LLVMFloatType (), 4))
INTRINS_OVR(AARCH64_CEIL_V2F32, ceil, LLVMVectorType (LLVMFloatType (), 2))
INTRINS_OVR(AARCH64_CEIL_V1F64, ceil, LLVMVectorType (LLVMDoubleType (), 1))
INTRINS_OVR(AARCH64_CEIL_F32, ceil, LLVMFloatType ())
INTRINS_OVR(AARCH64_FLOOR_V4F32, floor, LLVMVectorType (LLVMFloatType (), 4))
INTRINS_OVR(AARCH64_FLOOR_V2F32, floor, LLVMVectorType (LLVMFloatType (), 2))
INTRINS_OVR(AARCH64_FLOOR_V1F64, floor, LLVMVectorType (LLVMDoubleType (), 1))
INTRINS_OVR(AARCH64_FLOOR_F32, floor, LLVMFloatType ())
#endif
